...
However, there are two issues with the original GN file. These have been
dealt with in the files footballTSE* provided in this archive. If you use
these corrected file then please cite T.S. Evans, "Clique Graphs and
Overlapping Communities", arXiv:1009.0638 in addition to the GN publication.
