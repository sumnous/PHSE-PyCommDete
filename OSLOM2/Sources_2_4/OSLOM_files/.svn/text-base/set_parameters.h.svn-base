...
void general_program_statement(char * b) {
	...
	cout<<"\n  [-all]:\t\t\tno singletons. If you don't use this flag, the program generally finds a number of nodes which are not assigned to any module. If you don't like these homeless guys, set this option:\n\t\t\t\t";
...
Parameters::Parameters() {
	...
	command_flags.insert(make_pair("-all", 3));	
